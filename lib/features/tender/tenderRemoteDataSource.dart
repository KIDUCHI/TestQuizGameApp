...
import 'package:flutterquiz/features/tender/tenderException.dart';
...
class TenderRemoteDataSource {
  ...
  Future<List?> getQuestionsForDailyTender(
    ...
    try {
      ...
      final response = await http.post(Uri.parse(getQuestionForDailyTenderUrl),
      ...
      if (responseJson['error']) {
        ...
        throw TenderException(errorMessageCode: responseJson['message']); //error
      }
      return responseJson['data'];
    } on SocketException catch (_) {
      throw TenderException(errorMessageCode: noInternetCode);
    } on TenderException catch (e) {
      throw TenderException(errorMessageCode: e.toString());
    } catch (e) {
      throw TenderException(errorMessageCode: defaultErrorMessageCode);
    }
  }
  ...
  Future<List?> getQuestionsForTenderZone(
      {required String languageId,
    ...
    try {
      ...
      print("tenderzone body getQuestionsForTenderZone $body");
      ...
      if (responseJson['error']) {
        throw TenderException(errorMessageCode: responseJson['message']);
      }
      return responseJson['data'];
    } on SocketException catch (_) {
      throw TenderException(errorMessageCode: noInternetCode);
  ...
  Future<List?> getQuestionByCategoryOrSubcategory({
    ...
    try {
      ...
      print("tenderzone body getQuestionByCategoryOrSubcategory $body");
   ...
   */
  Future<void> setTenderCategoryPlayed(
      {required String type,
      required String userId,
      required String categoryId,
      required String subcategoryId,
    ...
    try {
      ...
      print("Set tender category body : $body");
      final response = await http.post(Uri.parse(setTenderCategoryPlayedUrl),
          body: body, headers: await ApiUtils.getHeaders());
      final responseJson = jsonDecode(response.body);
      if (responseJson['error']) {
        print(responseJson);
