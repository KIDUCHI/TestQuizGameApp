...
import 'package:flutterquiz/features/tender/cubits/contestCubit.dart';
      ...
      builder: (_) => MultiBlocProvider(
        providers: [
          BlocProvider<ContestCubit>(
            create: (_) => ContestCubit(TenderRepository()),
          ),
  ...
  void _handleOnTap() {
    ...
    if (widget.contestType == _live) {
      if (int.parse(context.read<UserDetailsCubit>().getCoins()!) >=
        ...
        Navigator.of(context).pushReplacementNamed(Routes.tender, arguments: {
          "numberOfPlayer": 1,
          "tenderType": TenderTypes.contest,
