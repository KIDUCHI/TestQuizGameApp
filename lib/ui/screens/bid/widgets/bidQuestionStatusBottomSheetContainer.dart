...
class BidQuestionStatusBottomSheetContainer extends StatelessWidget {
  final PageController pageController;
  final Function navigateToResultScreen;

  const BidQuestionStatusBottomSheetContainer({
    super.key,
          ...
          children: [
            Align(
              ...
              child: Padding(
                ...
                child: Text(
                  "${AppLocalization.of(context)!.getTranslatedValues(totalQuestionsKey)!} : ${context.read<BidCubit>().getQuestions().length}",
                  style: TextStyle(
                    color: Theme.of(context).colorScheme.onTertiary,
                    fontSize: 18.0,
            ...
            ...context
              ...
              return _buildQuestionAttemptedByMarksContainer(
                ...
                questions:
                    context.read<BidCubit>().getQuestionsByMark(questionMark),
              );
            }).toList(),
            Padding(
