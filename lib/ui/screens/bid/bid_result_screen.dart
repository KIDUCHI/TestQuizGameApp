...
class BidResultScreen extends StatelessWidget {
  const BidResultScreen({super.key, required this.bidResult});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: QAppBar(
        elevation: 0,
        title: Text(
          AppLocalization.of(context)!.getTranslatedValues(bidResultKey)!,
        ),
      ),
      body: SingleChildScrollView(
        child: Column(
          children: [
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    ...
                    child: Text(
                      "Obtained Marks : ${bidResult.obtainedMarks()}/${bidResult.totalMarks}",
                      style: TextStyle(
                        fontSize: 16,
                      ...
                      children: [
                        Text.rich(
                          TextSpan(
                            ...
                            children: [
                              TextSpan(
                                text: "${bidResult.totalCorrectAnswers()}\n",
                              ),
                              const TextSpan(
                        ...
                        Text.rich(
                          TextSpan(
                            ...
                            children: [
                              TextSpan(
                                text: "${bidResult.totalInCorrectAnswers()}\n",
                              ),
                              const TextSpan(
            ...
            ...bidResult.getUniqueMarksOfQuestion().map(
                  (marks) => _StatCard(
                    marks: marks,
                    totalQues:
                        bidResult.totalQuestionsByMark(marks).toString(),
                    correctAns:
                        bidResult.totalCorrectAnswersByMark(marks).toString(),
                    incorrectAns: bidResult
